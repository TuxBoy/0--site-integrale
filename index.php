...
<html lang="fr"> <!-- quand j'aurais un meilleur niveau en anglais, il faudrait passer le site en anglais afin qu'on sois meilleur auniveau du référencement. Actuellement, le site est dev en local. -->  
    ...
    <script src="carte/js/Ajax.js"></script>
    <script src="carte/js/Map.js"></script>
...
<!-- au besoin 
  ...
  <body>
    ...
    <div id="macarte" style="width:1560px; height:400px"></div>

    <script>
      Ajax.get('carte/api/get-info-map.php').then((res) => {
        const map = new Map(L).createMap(46.3630104, 2.9846608, 6, res.data)
      })
    </script>
